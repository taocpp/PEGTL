...
namespace pegtl
{
   void unit_test()
   {
      ...
      verify_rule< rep_min< 2, string< 'a', 'a' > > >( __LINE__, __FILE__,  "a", result_type::LOCAL_FAILURE, 1 );
      verify_rule< rep_min< 2, string< 'a', 'a' > > >( __LINE__, __FILE__,  "aa", result_type::LOCAL_FAILURE, 2 );
      verify_rule< rep_min< 2, string< 'a', 'a' > > >( __LINE__, __FILE__,  "aaa", result_type::LOCAL_FAILURE, 3 );
      verify_rule< rep_min< 2, string< 'a', 'a' > > >( __LINE__, __FILE__,  "aaaa", result_type::SUCCESS, 0 );
      verify_rule< rep_min< 2, string< 'a', 'a' > > >( __LINE__, __FILE__,  "aaaaa", result_type::SUCCESS, 1 );
      verify_rule< rep_min< 2, string< 'a', 'a' > > >( __LINE__, __FILE__,  "aaaaaa", result_type::SUCCESS, 0 );
      verify_rule< rep_min< 2, string< 'a', 'a' > > >( __LINE__, __FILE__,  "aaaaaaa", result_type::SUCCESS, 1 );
   }

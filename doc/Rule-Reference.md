...
- *Global failure* or an exception (usually of type `tao::parse_error`) that is usually generated by a control-class' static `raise()` member function.
...
* Calls the control-class' static `Control< T >::raise()` member function.

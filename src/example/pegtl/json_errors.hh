...
#ifndef TAOCPP_PEGTL_INCLUDE_EXAMPLES_JSON_ERRORS_HH
#define TAOCPP_PEGTL_INCLUDE_EXAMPLES_JSON_ERRORS_HH
...
namespace examples
{
   ...
   // to the PEGTL default control class tao::pegtl::normal<>
   // except for the throwing of exceptions:

   template< typename Rule >
   struct errors
         : public tao::pegtl::normal< Rule >
   {

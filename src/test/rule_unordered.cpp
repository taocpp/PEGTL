...
namespace TAO_PEGTL_NAMESPACE
{
   ...
   void unit_test()
   {
      verify_ctrl_enabled< unordered<> >( __LINE__, __FILE__, "" );
      verify_ctrl_disabled< internal::unordered< false > >( __LINE__, __FILE__, "" );
      verify_ctrl_enabled< unordered< a > >( __LINE__, __FILE__, "a" );
      verify_ctrl_disabled< internal::unordered< false, a > >( __LINE__, __FILE__, "a" );
      verify_ctrl_enabled< unordered< a, b, c > >( __LINE__, __FILE__, "abc" );
      verify_ctrl_disabled< internal::unordered< false, a, b, c > >( __LINE__, __FILE__, "abc" );

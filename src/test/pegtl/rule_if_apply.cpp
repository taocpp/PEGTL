...
namespace TAO_PEGTL_NAMESPACE
{
   ...
   void unit_test()
   {
      ...
      {
         bool state_b = false;
         TAO_PEGTL_TEST_ASSERT( !parse< if_apply< plus< alpha >, test1::action2_a, test1::action2_b, test1::action2_c > >( text_view_input< ascii::lf >( "foo bar" ), state_b ) );
         TAO_PEGTL_TEST_ASSERT( state_b );
      }

      {
         bool state_b = false;
         TAO_PEGTL_TEST_ASSERT( !parse< if_apply< plus< alpha >, test1::action2_a, test1::action2_b, test1::action2_c > >( text_view_input< ascii::lf >( "" ), state_b ) );
         TAO_PEGTL_TEST_ASSERT( !state_b );
      }

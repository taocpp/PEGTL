...
namespace TAO_PEGTL_NAMESPACE
{
   ...
   void test_count()
   {
      internal::input_with_offset< false, copy_input< scan::lf > > in( data );
   ...
   {
      internal::input_with_offset< true, copy_input< scan::lf > > in( count_position( 42 ), data );
   ...
   {
      internal::input_with_offset< true, copy_input< scan::lf, std::string, const char*, std::string > > in( count_position( 42 ), __FUNCTION__, data );
      TAO_PEGTL_TEST_ASSERT( in.current_position().count == 42 );
   ...
   void test_text()
   {
      internal::input_with_offset< false, text_copy_input< scan::lf > > in( data );
      TAO_PEGTL_TEST_ASSERT( in.current_position().count == 0 );
   ...
   void test_lazy()
   {
      internal::input_with_offset< false, text_copy_input< lazy::lf > > in( data );
      TAO_PEGTL_TEST_ASSERT( in.current_position().count == 0 );
      TAO_PEGTL_TEST_ASSERT( in.current_position().line == 1 );
      TAO_PEGTL_TEST_ASSERT( in.current_position().column == 1 );
      TAO_PEGTL_TEST_ASSERT( in.current_position() == in.previous_position( in.rewind_position() ) );

...
namespace TAO_PEGTL_NAMESPACE
{
   ...
   void test_count()
   {
      internal::input_with_offset< false, copy_input< eols::scan::lf > > in( data );
   ...
   {
      internal::input_with_offset< true, copy_input< eols::scan::lf > > in( count_position( 42 ), data );
   ...
   {
      internal::input_with_offset< true, copy_input< eols::scan::lf, std::string, const char*, std::string > > in( count_position( 42 ), __FUNCTION__, data );
      TAO_PEGTL_TEST_ASSERT( in.current_position().count == 42 );
   ...
   void test_text()
   {
      internal::input_with_offset< false, text_copy_input< eols::scan::lf > > in( data );
      TAO_PEGTL_TEST_ASSERT( in.current_position().count == 0 );
   ...
   {
      internal::input_with_offset< true, text_copy_input< eols::scan::lf > > in( text_position( 100, 200, 300 ), data );
   ...
   {
      internal::input_with_offset< true, text_copy_input< eols::scan::lf, std::string, std::string, std::string > > in( text_position( 100, 200, 300 ), __FUNCTION__, data );
      TAO_PEGTL_TEST_ASSERT( in.current_position().count == 100 );
      TAO_PEGTL_TEST_ASSERT( in.current_position().line == 200 );
      TAO_PEGTL_TEST_ASSERT( in.current_position().column == 300 );
      TAO_PEGTL_TEST_ASSERT( in.current_position().source == __FUNCTION__ );

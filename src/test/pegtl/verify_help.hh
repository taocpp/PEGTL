...
#ifndef TAOCPP_PEGTL_INCLUDE_UNIT_TESTS_VERIFY_HELP_HH
#define TAOCPP_PEGTL_INCLUDE_UNIT_TESTS_VERIFY_HELP_HH
...
#include <tao/pegtl/normal.hh>
#include <tao/pegtl/nothing.hh>
#include <tao/pegtl/apply_mode.hh>
#include <tao/pegtl/rewind_mode.hh>

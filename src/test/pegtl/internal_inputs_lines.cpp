...
namespace TAO_PEGTL_NAMESPACE
{
   void test_01_lines()
   {
      using input_t = internal::input_with_lines< ascii::lf, internal::input_with_fakes< internal::view_input< char > > >;
      {
         input_t in( "" );
   ...
   void test_02_lines()
   {
      using input_t = internal::input_with_lines< ascii::lf_crlf, internal::input_with_fakes< internal::view_input< char > > >;
      {
         input_t in( "" );
         const auto* start = in.current();
         TAO_PEGTL_TEST_ASSERT( in.empty() );

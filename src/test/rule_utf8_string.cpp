...
namespace TAO_PEGTL_NAMESPACE
{
   void unit_test()
   {
      static_assert( std::is_same_v< utf8::string< 1 >::rule_t, internal::terminal< internal::one< internal::peek_char, 1 > > > );
      static_assert( std::is_same_v< utf8::string< 1, 2, 3 >::rule_t, internal::ascii_string< 1, 2, 3 > > );
      static_assert( std::is_same_v< utf8::string< 127 >::rule_t, internal::terminal< internal::one< internal::peek_char, 127 > > > );

...
namespace TAO_PEGTL_NAMESPACE
{
   void unit_test()
   {
      verify_meta< everything, internal::everything >();

      verify_ctrl_enabled< everything >( __LINE__, __FILE__, "abc" );
      verify_ctrl_disabled< internal::everything >( __LINE__, __FILE__, "abc" );

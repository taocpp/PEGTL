...
namespace TAO_PEGTL_NAMESPACE
{
   void unit_test()
   {
      ...
      verify_meta< consume< 1 >, internal::consume< 1 > >();
      verify_meta< consume< 42 >, internal::consume< 42 > >();

      verify_ctrl_enabled< consume< 3 > >( __LINE__, __FILE__, "abc" );
      verify_ctrl_disabled< internal::consume< 3 > >( __LINE__, __FILE__, "abc" );

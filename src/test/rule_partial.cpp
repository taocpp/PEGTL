...
namespace TAO_PEGTL_NAMESPACE
{
   ...
   void unit_test()
   {
      ...
      verify_rule< partial< one< 'a' > > >( __LINE__, __FILE__, "", result_type::success );
      verify_rule< partial< one< 'a' > > >( __LINE__, __FILE__, "a", result_type::success );
      verify_rule< partial< one< 'a' > > >( __LINE__, __FILE__, "b", result_type::success, 1 );
      verify_rule< partial< one< 'a' > > >( __LINE__, __FILE__, "bb", result_type::success, 2 );
      ...
      verify_rule< partial< one< 'a' >, one< 'b' > > >( __LINE__, __FILE__, "", result_type::success );
      verify_rule< partial< one< 'a' >, one< 'b' > > >( __LINE__, __FILE__, "a", result_type::success );
      verify_rule< partial< one< 'a' >, one< 'b' > > >( __LINE__, __FILE__, "ab", result_type::success );
      ...
      verify_rule< must< partial< one< 'a' > > > >( __LINE__, __FILE__, "a", result_type::success );
      ...
      verify_rule< must< partial< one< 'a' >, one< 'b' > > > >( __LINE__, __FILE__, "", result_type::success );
      verify_rule< must< partial< one< 'a' >, one< 'b' > > > >( __LINE__, __FILE__, "a", result_type::success );
      verify_rule< must< partial< one< 'a' >, one< 'b' > > > >( __LINE__, __FILE__, "b", result_type::success, 1 );
      verify_rule< must< partial< one< 'a' >, one< 'b' > > > >( __LINE__, __FILE__, "bb", result_type::success, 2 );
      verify_rule< must< partial< one< 'a' >, one< 'b' > > > >( __LINE__, __FILE__, "ab", result_type::success );
      ...
      bool success = false;
      TAO_PEGTL_TEST_ASSERT( parse< partial< eof >, my_action >( text_view_input< scan::lf >( "" ), success ) );

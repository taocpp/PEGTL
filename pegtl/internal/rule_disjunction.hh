...
namespace pegtl
{
   namespace internal
   {
      ...
      struct rule_disjunction< Rule, Rules ... >
      {
         ...
         {
            return Control< Rule >::template match< error_mode::RETURN, Action, Control >( in, st ... ) || rule_disjunction< Rules ... >::template match< error_mode::RETURN, Action, Control >( in, st ... );
         }
      };

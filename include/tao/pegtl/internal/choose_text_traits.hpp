...
namespace TAO_PEGTL_NAMESPACE::internal
{
   ...
   void choose_text_traits( Position& pos, const Data* data, const std::size_t count )
   {
      ...
      if constexpr( has_eol_char_rule< Eol > ) {
         text_scan_traits< Eol, typename Rule::rule_t >::scan( pos, data, count );
      }
      else {
         text_rule_traits< Eol, typename Rule::rule_t >::scan( pos, data, count );
      }
   }

...
#ifndef TAO_PEGTL_BINARY_INTERNAL_INTEGER_BSWAP_GCC_CLANG_HPP
#define TAO_PEGTL_BINARY_INTERNAL_INTEGER_BSWAP_GCC_CLANG_HPP
...
{
   template< typename T >
   [[nodiscard]] T integer_bswap( const T n ) noexcept
   {

...
#ifndef TAO_PEGTL_ASCII7_HPP
#define TAO_PEGTL_ASCII7_HPP
...
namespace TAO_PEGTL_NAMESPACE
{
   namespace ascii7
   {
      ...
      template< char... Cs > struct not_one : internal::not_one< internal::peek_ascii7, Cs... > {};
      template< char Lo, char Hi > struct not_range : internal::not_range< internal::peek_ascii7, Lo, Hi > {};

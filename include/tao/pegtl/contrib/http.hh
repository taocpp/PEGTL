...
#ifndef TAOCPP_PEGTL_INCLUDE_CONTRIB_HTTP_HH
#define TAOCPP_PEGTL_INCLUDE_CONTRIB_HTTP_HH
...
namespace TAOCPP_PEGTL_NAMESPACE
{
   namespace http
   {
      ...
      struct HTTP_version : if_must< tao_pegtl_string_t( "HTTP/" ), DIGIT, one< '.' >, DIGIT > {};
      ...
      struct transfer_coding : sor< tao_pegtl_istring_t( "chunked" ),
                                    tao_pegtl_istring_t( "compress" ),
                                    tao_pegtl_istring_t( "deflate" ),
                                    tao_pegtl_istring_t( "gzip" ),
                                    transfer_extension > {};
      ...
      struct t_codings : sor< tao_pegtl_istring_t( "trailers" ), seq< transfer_coding, opt< t_ranking > > > {};
      ...
      struct http_URI : if_must< tao_pegtl_istring_t( "http://" ), uri::authority, uri::path_abempty, uri::opt_query, uri::opt_fragment > {};
      struct https_URI : if_must< tao_pegtl_istring_t( "https://" ), uri::authority, uri::path_abempty, uri::opt_query, uri::opt_fragment > {};

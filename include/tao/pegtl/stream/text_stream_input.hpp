...
#ifndef TAO_PEGTL_STREAM_TEXT_STREAM_INPUT_HPP
#define TAO_PEGTL_STREAM_TEXT_STREAM_INPUT_HPP
...
namespace TAO_PEGTL_NAMESPACE::internal
{
   ...
   public:
      ...
      text_stream_input( text_stream_input&& ) = delete;
      text_stream_input( const text_stream_input& ) = delete;

      ~text_stream_input() = default;

      void operator=( text_stream_input&& ) = delete;
      void operator=( const text_stream_input& ) = delete;

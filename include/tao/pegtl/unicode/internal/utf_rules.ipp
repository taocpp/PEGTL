...
namespace TAO_PEGTL_NAMESPACE::TAO_PEGTL_UTF_NAME
{
   ...
   template< char32_t... Cs > struct not_ranges : internal::not_ranges< TAO_PEGTL_UTF_PEEK, Cs... > {};
   template< char32_t... Cs > struct one : internal::utf_one< TAO_PEGTL_UTF_PEEK, Cs... > {};

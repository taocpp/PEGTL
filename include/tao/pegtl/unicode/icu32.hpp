...
#ifndef TAO_PEGTL_UNICODE_ICU32_HPP
...
namespace TAO_PEGTL_NAMESPACE
{
   namespace utf32_be::icu
   {
      ...
      struct binary_property
         : internal::icu_binary_property< internal::peek_utf32_be, P, V >
      {};

      template< UProperty P, int V >
      struct property_value
         : internal::icu_property_value< internal::peek_utf32_be, P, V >
      {};
...
#include "internal/icu_rules.ipp"  // NOLINT(readability-duplicate-include)
   ...
   namespace utf32_le::icu
   {
      template< UProperty P, bool V = true >
      struct binary_property
         : internal::icu_binary_property< internal::peek_utf32_le, P, V >
      {};

      template< UProperty P, int V >
      struct property_value
         : internal::icu_property_value< internal::peek_utf32_le, P, V >
      {};
